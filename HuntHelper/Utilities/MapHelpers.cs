...
public class MapHelpers
{
    ...
    {
        {"中拉诺西亚","Middle La Noscea"},{"拉诺西亚低地","Lower La Noscea"},{"东拉诺西亚","Eastern La Noscea"},{"西拉诺西亚","Western La Noscea"},{"拉诺西亚高地","Upper La Noscea"},{"拉诺西亚外地","Outer La Noscea"},// 拉诺西亚
        {"黑衣森林中央林区","Central Shroud"},{"黑衣森林东部林区","East Shroud"},{"黑衣森林南部林区","South Shroud"},{"黑衣森林北部林区","North Shroud"},//黑衣森林
        {"西萨纳兰","Western Thanalan"},{"中萨纳兰","Central Thanalan"},{"东萨纳兰","Eastern Thanalan"},{"南萨纳兰","Southern Thanalan"},{"北萨纳兰","Northern Thanalan"},//萨那兰
        ...
        {"基巴拉尼亚边区","The Fringes"},{"红玉海","The Ruby Sea"},{"基巴拉尼亚山区","The Peaks"},{"延夏","Yanxia"},{"基巴拉尼亚湖区","The Lochs"},{"太阳神草原","The Azim Steppe"},//4.0
